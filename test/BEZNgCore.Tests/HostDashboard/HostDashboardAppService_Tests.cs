...
using BEZNgCore.MultiTenancy.HostDashboard;
...
namespace BEZNgCore.Tests.HostDashboard;
...
public class HostDashboardAppService_Tests : AppTestBase
{
    ...
    private void CreatePaidPayment(BEZNgCoreDbContext context, SubscriptionPayment subscriptionPayment)
    {
