...
namespace BEZNgCore.Organizations;

public class UserOrganizationUnitRepository : BEZNgCoreRepositoryBase<UserOrganizationUnit, long>,
    IUserOrganizationUnitRepository
{
    public UserOrganizationUnitRepository(IDbContextProvider<BEZNgCoreDbContext> dbContextProvider)
