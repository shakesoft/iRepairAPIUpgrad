...
public class UserRepository : BEZNgCoreRepositoryBase<User, long>, IUserRepository
{
    public UserRepository(IDbContextProvider<BEZNgCoreDbContext> dbContextProvider)
