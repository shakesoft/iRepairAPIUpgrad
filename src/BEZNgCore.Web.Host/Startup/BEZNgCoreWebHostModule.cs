...
using BEZNgCore.Authorization.Users.Password;
...
using BEZNgCore.Web.Startup.ExternalLoginInfoProviders;

namespace BEZNgCore.Web.Startup;

[DependsOn(
    typeof(BEZNgCoreWebCoreModule)
)]
public class BEZNgCoreWebHostModule : AbpModule
{
    private readonly IWebHostEnvironment _env;
    private readonly IConfigurationRoot _appConfiguration;

    public BEZNgCoreWebHostModule(
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(BEZNgCoreWebHostModule).GetAssembly());
    }
    ...
    public override void PostInitialize()
    {
        ...
        {
            if (!scope.Resolve<DatabaseCheckHelper>().Exist(_appConfiguration["ConnectionStrings:TEST"]))
            {
                return;
            }
        }
