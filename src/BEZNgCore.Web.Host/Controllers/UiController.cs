...
using BEZNgCore.Web.Models.Ui;
using BEZNgCore.Web.Session;
using System.Threading.Tasks;

namespace BEZNgCore.Web.Controllers;

public class UiController : BEZNgCoreControllerBase
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        if (_databaseCheckHelper.Exist(_appConfiguration[$"ConnectionStrings:{BEZNgCoreConsts.ConnectionStringName}"]))
        {
