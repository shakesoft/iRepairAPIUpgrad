...
using BEZNgCore.Url;
using BEZNgCore.Web.Public.Startup;
using BEZNgCore.Web.Session;
using System.Linq;
using System.Threading.Tasks;

namespace BEZNgCore.Web.Public.Views.Shared.Components.Header;

public class HeaderViewComponent : BEZNgCoreViewComponent
{
