...
namespace BEZNgCore.Web.Public.Startup;

[DependsOn(
    typeof(BEZNgCoreWebCoreModule)
)]
public class BEZNgCoreWebFrontEndModule : AbpModule
{
    private readonly IConfigurationRoot _appConfiguration;

    public BEZNgCoreWebFrontEndModule(IWebHostEnvironment env, BEZNgCoreEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
    {
    ...
    {
        IocManager.RegisterAssemblyByConvention(typeof(BEZNgCoreWebFrontEndModule).GetAssembly());
    }
}
