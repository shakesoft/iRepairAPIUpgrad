...
using BEZNgCore.UiCustomization.Dto;

namespace BEZNgCore.Web.UiCustomization.Metronic;
...
public class Theme10UiCustomizer : UiThemeCustomizerBase, IUiCustomizer
{
    ...
    public async Task<UiCustomizationSettingsDto> GetUiSettings()
    {
        ...
        settings.BaseSettings.SubHeader.TitleStyle = "d-flex flex-column text-gray-900 fw-bold fs-3 mb-0";
