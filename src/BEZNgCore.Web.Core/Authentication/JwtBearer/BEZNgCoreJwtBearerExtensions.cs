...
/// </summary>
public static class BEZNgCoreJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, BEZNgCoreAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
