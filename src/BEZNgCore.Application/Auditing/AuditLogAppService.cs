...
using BEZNgCore.Auditing.Exporting;
...
using EntityHistoryHelper = BEZNgCore.EntityHistory.EntityHistoryHelper;

namespace BEZNgCore.Auditing;

[DisableAuditing]
[AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
public class AuditLogAppService : BEZNgCoreAppServiceBase, IAuditLogAppService
{
