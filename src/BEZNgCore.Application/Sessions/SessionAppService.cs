...
public class SessionAppService : BEZNgCoreAppServiceBase, ISessionAppService
{
        ...
        return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    CurrencySign = BEZNgCoreConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = BEZNgCoreConsts.AllowTenantsToChangeEmailSettings,
