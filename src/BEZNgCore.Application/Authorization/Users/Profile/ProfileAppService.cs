...
[AbpAuthorize]
public class ProfileAppService : BEZNgCoreAppServiceBase, IProfileAppService
{
    ...
    public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
    {
        ...
        userProfileEditDto.QrCodeSetupImageUrl = userProfileEditDto.IsGoogleAuthenticatorEnabled
            ? _googleTwoFactorAuthenticateService.GenerateSetupCode("BEZNgCore",
