...
public class UserAppService : BEZNgCoreAppServiceBase, IUserAppService
{
    ...
    public async Task<FileDto> GetUsersToExcel(GetUsersToExcelInput input)
    {
        ...
        return await _userListExcelExporter.ExportToFile(userListDtos, input.SelectedColumns);
    }
