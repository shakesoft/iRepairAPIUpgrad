...
using BEZNgCore.DashboardCustomization.Dto;

namespace BEZNgCore.DashboardCustomization;

[AbpAuthorize]
public class DashboardCustomizationAppService : BEZNgCoreAppServiceBase, IDashboardCustomizationAppService
{
