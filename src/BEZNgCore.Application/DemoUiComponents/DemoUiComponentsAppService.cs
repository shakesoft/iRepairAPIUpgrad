...
using BEZNgCore.DemoUiComponents.Dto;

namespace BEZNgCore.DemoUiComponents;

[AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
public class DemoUiComponentsAppService : BEZNgCoreAppServiceBase, IDemoUiComponentsAppService
{
