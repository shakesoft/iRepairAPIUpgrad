...
using BEZNgCore.Migrations.Seed.Host;
...
[AbpAllowAnonymous]
[DisableAuditing]
public class InstallAppService : BEZNgCoreAppServiceBase, IInstallAppService
{
    private readonly AbpZeroDbMigrator<BEZNgCoreDbContext> _migrator;
    ...
    {
        var connectionString = _appConfiguration[$"ConnectionStrings:{BEZNgCoreConsts.ConnectionStringName}"];
    ...
    {
        EditAppSettingsjson($"ConnectionStrings:{BEZNgCoreConsts.ConnectionStringName}", constring);
    }
