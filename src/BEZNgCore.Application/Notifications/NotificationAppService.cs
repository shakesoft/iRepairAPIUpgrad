...
using BEZNgCore.Organizations;

namespace BEZNgCore.Notifications;

[AbpAuthorize]
public class NotificationAppService : BEZNgCoreAppServiceBase, INotificationAppService
{
    ...
    public async Task CreateMassNotification(CreateMassNotificationInput input)
    {
        ...
        if (input.OrganizationUnitIds.IsNullOrEmpty() && input.UserIds.IsNullOrEmpty())
        {
