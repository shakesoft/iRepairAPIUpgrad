...
using BEZNgCore.MultiTenancy.Payments.Paypal;
using BEZNgCore.MultiTenancy.Payments.PayPal;
using BEZNgCore.MultiTenancy.Payments.PayPal.Dto;

namespace BEZNgCore.MultiTenancy.Payments;

public class PayPalPaymentAppService : BEZNgCoreAppServiceBase, IPayPalPaymentAppService
{
