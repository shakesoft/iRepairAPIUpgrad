...
using BEZNgCore.Maui.Services.Permission;
using BEZNgCore.Maui.Services.UI;

namespace BEZNgCore.Maui.Core.Components;

public class BEZNgCoreMainLayoutPageComponentBase : BEZNgCoreComponentBase
{
    ...
    public BEZNgCoreMainLayoutPageComponentBase()
    {
