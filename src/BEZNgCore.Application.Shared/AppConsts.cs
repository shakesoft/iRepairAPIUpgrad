...
public class AppConsts
{
    ...
    /// </summary>
    public const string DefaultPassPhrase = "caaa3e9331d34cb59d09a834a0eb7ee6";
    ...
    public static TimeSpan TwoFactorRememberClientTokenExpiration = TimeSpan.FromDays(365);
}
