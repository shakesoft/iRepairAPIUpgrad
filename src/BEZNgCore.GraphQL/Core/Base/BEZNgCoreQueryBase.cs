...
namespace BEZNgCore.Core.Base;

public abstract class BEZNgCoreQueryBase<TField, TResult> : ITransientDependency
{
    ...
    protected BEZNgCoreQueryBase(string fieldName,
