...
using BEZNgCore.Core.Base;
using BEZNgCore.Core.Extensions;
using BEZNgCore.Dto;
using BEZNgCore.Types;

namespace BEZNgCore.Queries;

public class OrganizationUnitQuery : BEZNgCoreQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
{
