...
using BEZNgCore.Authentication;
using BEZNgCore.DashboardCustomization;
...
public class AppSettingProvider : SettingProvider
{
    ...
    {
        if (!BEZNgCoreConsts.AllowTenantsToChangeEmailSettings)
        {
        ...
        return new[]
        {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        BEZNgCoreConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant),
    ...
    private IEnumerable<SettingDefinition> GetDashboardSettings()
    {
        ...
        var reactDefaultHostView = GetDefaultReactHostDashboardView();
        var reactDefaultTenantView = GetDefaultReactTenantDashboardView();
        ...
        return new[]
        {
                new SettingDefinition(
                    GetSettingName(
                        BEZNgCoreDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        BEZNgCoreDashboardCustomizationConsts.Applications.Angular,
                ...
                new SettingDefinition(
                    GetSettingName(
                        BEZNgCoreDashboardCustomizationConsts.Applications.React,
                        reactDefaultHostView.DashboardName
                    ),
                    reactDefaultHostView.ToJsonString(),
                    scopes: SettingScopes.All,
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider
                ),
                new SettingDefinition(
                    GetSettingName(
                        BEZNgCoreDashboardCustomizationConsts.Applications.React,
                        reactDefaultTenantView.DashboardName
                    ),
                    reactDefaultTenantView.ToJsonString(),
                    scopes: SettingScopes.All,
                    clientVisibilityProvider: _visibleSettingClientVisibilityProvider
                )
            };
    ...
    public Dashboard GetDefaultMvcHostDashboardView()
    {
        ...
        {
            DashboardName = BEZNgCoreDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{BEZNgCoreDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{BEZNgCoreDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = BEZNgCoreDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = BEZNgCoreDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    BEZNgCoreDashboardCustomizationConsts.Widgets.Host
    ...
    public Dashboard GetDefaultMvcTenantDashboardView()
    {
        ...
        return new Dashboard
        {
            DashboardName = BEZNgCoreDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
            Pages = new List<Page>
                {
                    new Page($"Page_{BEZNgCoreDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{BEZNgCoreDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = BEZNgCoreDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = BEZNgCoreDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    BEZNgCoreDashboardCustomizationConsts.Widgets.Tenant
    ...
    public Dashboard GetDefaultReactHostDashboardView()
    {
        // It is the default dashboard view which your user will see if they don't do any customization.
        return new Dashboard
        {
    ...
    public Dashboard GetDefaultReactTenantDashboardView()
    {
        //It is the default dashboard view which your user will see if they don't do any customization.
        return new Dashboard
        {
