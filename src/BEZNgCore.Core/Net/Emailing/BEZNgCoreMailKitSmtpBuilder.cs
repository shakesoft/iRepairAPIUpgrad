...
public class BEZNgCoreMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
{
    private readonly ILocalizationManager _localizationManager;
    private readonly IEmailSettingsChecker _emailSettingsChecker;

    public BEZNgCoreMailKitSmtpBuilder(
    ...
    {
        return _localizationManager.GetString(BEZNgCoreConsts.LocalizationSourceName, name);
    }
