...
/// </summary>
public class BEZNgCoreSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public BEZNgCoreSimplePermissionDependency()
    {
    ...
    public BEZNgCoreSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public BEZNgCoreSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
